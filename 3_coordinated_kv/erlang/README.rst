...
you should see something like this::
    ...
    -------------------------------------------------------------------------------
    joining     0.0%      --      'coordinated_kv2@127.0.0.1'
    joining     0.0%      --      'coordinated_kv3@127.0.0.1'
    valid     100.0%      --      'coordinated_kv1@127.0.0.1'
    -------------------------------------------------------------------------------
...
you could see the vnodes transfering::
    ...
    Status     Ring    Pending    Node
    -------------------------------------------------------------------------------
    valid      75.0%     25.0%    'coordinated_kv1@127.0.0.1'
    valid       9.4%     25.0%    'coordinated_kv2@127.0.0.1'
    valid       7.8%     25.0%    'coordinated_kv3@127.0.0.1'
    -------------------------------------------------------------------------------
...
at some point you should see something like this::
    ...
    Status     Ring    Pending    Node
    -------------------------------------------------------------------------------
    valid      33.3%      --      'coordinated_kv1@127.0.0.1'
    valid      33.3%      --      'coordinated_kv2@127.0.0.1'
    valid      33.3%      --      'coordinated_kv3@127.0.0.1'
    -------------------------------------------------------------------------------
    Valid:3 / Leaving:0 / Exiting:0 / Joining:0 / Down:0
